...
public class VuforiaStuffRED {

    VuforiaLocalizer vuforia;

    public VuforiaStuffRED(VuforiaLocalizer vuforia) {
        ...
        */
        ...
        if (rgbImage != null) {
            ...
            if (red) {      // Assume your starting on the RED Alliance
                cropStartX = (int) ((150.0 / 720.0) * bitmap.getWidth());           // 1/29/20    Was ((120.0 / 720)    changing to ((150.0 / 720)
                cropStartY = (int) ((100 / 480.0) * bitmap.getHeight());
                cropWidth = (int) ((530.0 / 720.0) * bitmap.getWidth());            // 1/29/20    Was ((590.0 / 720)    changing to ((530.0 / 720)
        ...
        /* if ((blackYellowRatioL > blackYellowRatioC)) {
             if (blackYellowRatioL > blackYellowRatioR) {
                 pos = skystonePos.LEFT;
             } else if (blackYellowRatioC > blackYellowRatioL) {
                 if (blackYellowRatioC > blackYellowRatioR){
                     pos = skystonePos.CENTER;
                 }
             }
         } else if (blackYellowRatioL > blackYellowRatioR || blackYellowRatioL > blackYellowRatioC){
             pos = skystonePos.RIGHT; */
